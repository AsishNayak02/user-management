...
import { updateRole, getAllClients, getClientRoles } from "@/api/roleManagement"
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        await updateRole(role.id, {
          ...
          clientRoleIds: values.clientRoleIds,
        });
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Update role details and manage client role assignments.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={formik.handleSubmit} className="flex-1 flex flex-col overflow-hidden">
          <div className="flex-1 overflow-y-auto space-y-4">
            ...
            <div className="space-y-3">
              <Label>Manage Client Role Assignments</Label>
                      ...
                      return (
                        <div key={clientRole.id} className="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded">
                          <input
                            ...
                            id={clientRole.id}
                            checked={isSelected}
                            onChange={(e) => handleRoleToggle(clientRole.id, e.target.checked)}
                            className="rounded"
                          />
